      ...
      { $ref: 'http://express-gateway.io/schemas/base/auth.json' },
      {
        ...
        properties: {
          ...
          autoRefreshCache: {
            type: 'boolean',
            default: false,
            description: 'If enabled with a ttl greater than 5 sconds. It will refresh the cache in background when the ttl of a token near expiration, keeping the cache warm.'
          }
        }
      }
    ]
